...
('admin1', 'adminpassword1','A'),
('admin2', 'adminpassword2','A'),
('admin3', 'adminpassword3','D');
...
(NOW(), '123 Main Street', 50.00, 1),
(NOW(), '456 Elm Street', 75.00, 0),
(NOW(), '789 Oak Street', 100.00, 0);

INSERT INTO delivery (delivery_date, delivery_address, cost, status) VALUES
(NOW() + INTERVAL '1 DAY', '123 Main Street', 50.00, 1),
(NOW() + INTERVAL '1 DAY', '456 Elm Street', 75.00, 0),
(NOW() + INTERVAL '1 DAY', '789 Oak Street', 100.00, 0);
...
(10, NOW(), 'CTL0001','DLV0001','PMT0001'),
(15, NOW(), 'CTL0002','DLV0002','PMT0002'),
(5, NOW(), 'CTL0003','DLV0003','PMT0003');

INSERT INTO orders (reduction, ordering_date, id_client,id_delivery,id_payement) VALUES
(0, NOW() + INTERVAL '1 DAY', 'CTL0001','DLV0004','PMT0004'),
(10, NOW() + INTERVAL '1 DAY', 'CTL0002','DLV0005','PMT0005'),
(20, NOW() + INTERVAL '1 DAY', 'CTL0003','DLV0006','PMT0006');
