...
class Product
{
    ...
    public function __construct($id = null, $image_link = null, $description = null, $creation_date = null, $id_cat_product = null, $id_cat_fruit = null)
    {
        ...
        $this->CI->load->model('backoffice/Product_Model','Product_Model');
    ...
    public function reinsert_product($id)
    {
        return $this->CI->Product_Model->reinsert($id);
    }
    ...
    {
        return $this->CI->Product_Model->get_by_criteria($id_cat_fruit,$_id_cat_product);
    }
}
