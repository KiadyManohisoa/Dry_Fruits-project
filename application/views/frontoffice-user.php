                    ...
                    <div class="product col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="product-img" style="background-image: url('<?= site_url('assets/'.$product['product_image_link']) ?>')">
                            <div class="bag-icon bag">
                                <input type="checkbox" name="" id="new-check-<?php echo $product['id_product']; ?>" class="bag">
                                <label for="new-check-<?php echo $product['id_product']; ?>">
                                    <img src="<?php echo site_url('assets/icons/shopping-bag-disable.png') ?>">
                                </label>
                                <div class="option" id="new-option-<?php echo $product['id_product']; ?>">
                                    <button class="btn btn-default btn-block type" id="<?= $product['id_product']; ?>-B">Bulk</button>
                                    <button class="btn btn-default btn-block type" id="<?= $product['id_product']; ?>-W">Wholesale</button>
                                    <button class="btn btn-default btn-block type" id="<?= $product['id_product']; ?>-D">Detail</button>
                                </div>
                            </div>

                            <div class="bag-icon">
                                <label for="heart-<?= $product['id_product']; ?>">
                                    <input type="checkbox" class="heart" name="" id="heart-<?= $product['id_product']; ?>">
                                    <img src="<?= site_url('assets/icons/heart-disable.png') ?>">
                                </label>
                            </div>
                        </div>
                        <div class="product-desc">
                            <a href="<?= site_url('frontoffice/Products_Controller/get_product_by_id/'.$product['id_product'])?>"><h4><?= $product['product_name']; ?></h4></a>
        ...
        <form class="content" action="<?= site_url('frontoffice/Products_Controller/add_services_review/')?>" method="post">
            <div class="stars-div">
                <label for="1-star">
                    ...
                    <img src="<?php echo site_url('assets/icons/star-disable.png') ?>" class="star-disabled">
                    <img src="<?php echo site_url('assets/icons/star-enable.png') ?>" class="star-enabled">
                </label>
